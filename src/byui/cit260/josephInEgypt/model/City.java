...
public class City implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 41 * hash + this.numberOfWorkers;
        hash = 41 * hash + Objects.hashCode(this.statusOfSource);
        return hash;
    }

    @Override
    public String toString() {
        return "City{" + "numberOfWorkers=" + numberOfWorkers + ", statusOfSource=" + statusOfSource + '}';
    }
